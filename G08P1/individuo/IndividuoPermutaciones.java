...
public class IndividuoPermutaciones implements Individuo {
	...
	public IndividuoPermutaciones(Fitness fitness, float tol) {
	...
	{
		IndividuoPermutaciones in = new IndividuoPermutaciones(this._fitness, this._tolerance);
